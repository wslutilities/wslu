...
"${light_gray}              '^:ldxkkkkxdl:^'                  ${reset}");;
    'wlinux')
        t="${light_orange}${bold}"
        full_text=(
"${light_orange}        777++++++++++++++++++++++77        ${reset}"
"${light_orange}        7++++++++++++++++++++++++++7       ${reset}"
"${light_orange}      7++++++++++++++++++++++++++++++77    ${reset}"
"${light_orange}     7++++++++++++++,,,=++++++++++++++7    ${reset}"
"${light_orange}   7++++++++++++++,,,,,,,++++++++++++++?   ${reset}"
"${light_orange}  7?++++++++++++++,,,,.,,,++++++++++++++?7 ${reset}"
"${light_orange}  7++++++++++++++++,,+.+,,+++++++++++++++7 ${reset}"
"${light_orange}  ++++++++++++++++,++++:,,++++++++++++++++ ${reset}"
"${light_orange}  ++++++++++++++++,,,:++,,++++++++++++++++ ${reset}"
...
"${light_orange}  7+++++++++++++++++++++,,++++++,++++++++7 ${reset}"
"${light_orange}   7++++++=,++++++.,,,,,,,+++,++++++++++7  ${reset}"
"${light_orange}   77+++++++++++..++++++=~,,+++++++++++7   ${reset}"
"${light_orange}     7+++++++++++++++++++++++++++++++=77   ${reset}"
"${light_orange}     777++++++++++++++++++++++++++++777    ${reset}"
"${light_orange}       777++++++++++++++++++++++++777      ${reset}"
"${light_orange}          77=+++++++++++++++++++777        ${reset}"
"${light_orange}             777++++++++++++7777    	     ${reset}");;
    'sles')
        t="${green}${bold}"
        full_text=(
